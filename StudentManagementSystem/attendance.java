...
public class attendance extends JFrame implements ActionListener{
	...
	attendance(){
		...
		add(rl);
		JLabel grd=new JLabel("Enter Attendance Percentage");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==delete) {
			try {
				...
				if(rs.next()) {
					con.stm.executeUpdate("update add_student set attendance_per = '"+grd+"' where Roll_no = '"+rol+"'");

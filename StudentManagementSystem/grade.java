...
public class grade extends JFrame implements ActionListener{
	...
	grade(){
		...
		JLabel lb=new JLabel("UPADTE GRADE");
		...
		add(rl);
		JLabel grd=new JLabel("Enter Grade");
		...
		add(grdtext);
		delete =new JButton("GRADE");
		delete.setBounds(80,350,130,50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==delete) {
			try {
				...
				if(rs.next()) {
					con.stm.executeUpdate("update add_student set grade = '"+grd+"' where Roll_no = '"+rol+"'");
